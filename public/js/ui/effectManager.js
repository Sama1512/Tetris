  ...
  constructor(canvas, { comboLabel = "REN", badgeScale = 1.35 } = {}) {
    ...
    if (!document.getElementById("effects-style")) {
      ...
      style.textContent = `
        ...
        .fx-badge.b2b { background: linear-gradient(135deg, var(--badge-b2b-a), var(--badge-b2b-b)); color:#fff; text-shadow:0 1px 2px rgba(0,0,0,0.8); }
        .fx-badge.ren { background: linear-gradient(135deg, var(--badge-ren-a), var(--badge-ren-b)); color:#fff; text-shadow:0 1px 2px rgba(0,0,0,0.8); }
        .fx-badge.ac  { background: linear-gradient(135deg, var(--badge-ac-a),  var(--badge-ac-b));  color:#fff; text-shadow:0 1px 2px rgba(0,0,0,0.8); }
      `;
